...
public class PostOkState implements PostState {
  ...
  public History handleState(PostManager postManager) {
    var hist = new History(Status.POST_OK, postManager.getPostId());
...
//  @Serial
//  private static final long serialVersionUID = GlobalConstants.POST_STATE_POST_OK_serialVersionUID;
//  @Override
